...
export default function SettingsPage() {
  ...
  const VALID_TABS: SettingsTab[] = ['general', 'cashiers', 'notifications', 'menu', 'seder']
  const settingsTab: SettingsTab = VALID_TABS.includes(params.tab as SettingsTab) ? (params.tab as SettingsTab) : 'general'
  return (
    <div>
