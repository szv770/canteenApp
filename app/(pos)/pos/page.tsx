...
export default function PosPage() {
  ...
  return (
    <div className="h-screen bg-pos-bg flex flex-col overflow-hidden">
      {/* Header */}
      <header className="bg-white border-b border-pos-border px-3 sm:px-4 py-3 flex items-center gap-2 sm:gap-3 z-20 shrink-0">
        {/* Logo */}
        ...
        <div className="flex items-center gap-1 sm:gap-2 ml-1 shrink-0">
          ...
          {cashierRole === 'admin' && (
            <button
              ...
              className="p-2 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-xl text-pos-subtext hover:bg-pos-hover hover:text-pos-text transition-all"
              title="Admin"
            >
          ...
          <button
            onClick={signOut}
            className="p-2 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-xl text-pos-subtext hover:bg-red-50 hover:text-red-500 transition-all"
            title="Sign out"
          >
          ...
          <button
            ...
            className="lg:hidden relative p-2 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-xl text-pos-subtext hover:bg-pos-hover hover:text-pos-text transition-all"
        ...
        <div className="flex-1 flex flex-col overflow-hidden min-w-0">
          ...
          <div className="px-3 sm:px-4 pt-3 pb-2 shrink-0">
            <input
              ...
              className="w-full max-w-sm px-4 py-2.5 bg-white border border-pos-border rounded-xl text-pos-text placeholder-pos-muted focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand transition-all text-base"
            />
          </div>
